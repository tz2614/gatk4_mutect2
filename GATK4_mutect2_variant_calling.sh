...
reference_fa="/users/tz1/GATK4_Mutect2/refs/ucsc.hg19.HODS.fasta"
germline_vars="/users/tz1/GATK4_Mutect2/refs/af-only-gnomad.raw.sites.hg19.vcf.gz"
...
for bam in $(find $data_dir -name "*.bam")
	do
		...
		$gatk Mutect2 -R $reference_fa -L $interval_list -I $bam -O $unfiltered_vcf | tee $unfiltered_log &&
